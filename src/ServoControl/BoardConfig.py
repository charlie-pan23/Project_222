...
class BoardManager:
    def __init__(self):
        ...
        self.coords_table = {
            ...
            0:  [8.5, 7.5],    1: [8.5, 4.71],   2: [8.5, 1.93],     3: [8.5, -0.86],    4: [8.5, -3.64],    5: [8.5, -6.43],   6: [8.5, -9.21],    7: [8.5, -12.0],
            8:  [10.9, 7.5],   9: [10.9, 4.71],  10: [10.9, 1.93],  11: [10.9, -0.86],  12: [10.9, -3.64],  13: [10.9, -6.43],  14: [10.9, -9.21],  15: [10.9, -12.0],
            16: [13.3, 7.5],  17: [13.3, 4.71],  18: [13.3, 1.93],  19: [13.3, -0.86],  20: [13.3, -3.64],  21: [13.3, -6.43],  22: [13.3, -9.21],  23: [13.3, -12.0],
            24: [15.7, 7.5],  25: [15.7, 4.71],  26: [15.7, 1.93],  27: [15.7, -0.86],  28: [15.7, -3.64],  29: [15.7, -6.43],  30: [15.7, -9.21],  31: [15.7, -12.0],
