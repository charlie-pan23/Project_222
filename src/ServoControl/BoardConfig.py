...
class BoardManager:
    def __init__(self):
        ...
        self.coords_table = {
            ...
            32: [18.1, 8.33],  33: [18.1, 5.0],  34: [18.1, 3.2],  35: [18.1, 1.5],  36: [18.1, -0.5],  37: [18.1, -2.0],  38: [18.1, -3.8],  39: [18.1, -6.0],
            40: [20.5, 8.0],  41: [20.5, 5.0],  42: [20.5, 3.2],  43: [20.5, 1.5],  44: [20.5, -0.5],  45: [20.5, -2.0],  46: [20.5, -3.8],  47: [20.5, -6.0],
            48: [24.25, 8.0], 49: [24.25, 5.0], 50: [24.25, 3.2], 51: [24.25, 1.5], 52: [24.25, -0.5], 53: [24.25, -2.0], 54: [24.25, -3.8], 55: [24.25, -6.0],
            56: [28.0, 8.0],  57: [28.0, 5.0],  58: [28.0, 3.2],  59: [28.0, 1.5],  60: [28.0, -0.5],  61: [28.0, -2.0],  62: [28.0, -3.8],  63: [28.0, -6.0]
        }
